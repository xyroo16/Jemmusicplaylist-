...
let songs = [
    ...
    audioSrc: "audio/JPagsuko - Jireh Lim Official Music Video.mp3",
    videoBgSrc: "video/pagsuko.mp4.mp4",
    lyrics: [
    { time: 15.00, text: "Maari ba muna natin tong pag-usapan" },
    { time: 21.50, text: "Sa dami-rami na ng ating pinagdaanan" },
    { time: 28.30, text: "Ngayon mo pa ba maiisipang isuko" },
    { time: 34.30, text: "Ang lahat ng ating pinagsamahan" },
    { time: 40.70, text: "Masikip sa damdamin, hinigop ng hangin" },
    { time: 47.20, text: "Ang lakas, pinanghihinaan nang wagas" },
    { time: 53.60, text: "Pwede bang pag-isipan, huwag ka munang lumiban" },
    { time: 60.30, text: "Baka sakali na ito ay maisalba pa" },
    { time: 66.60, text: "Lumalamig ang gabi" },
    { time: 73.20, text: "Hindi na tulad ng dati" },
    { time: 81.70, text: "May pag-asa pa ba kung susuko ka na?" },
    { time: 88.70, text: "Larawan mo ba'y lulukutin ko na?" },
    { time: 94.70, text: "Sa hirap at ginhawa, tayo ay nagsama" },
    { time: 101.40, text: "Damdamin mo tila'y napagod na" },
    { time: 108.00, text: "Ikaw at ako ay alaala na lang" },
    { time: 113.50, text: "Kung susuko ka na" },
    { time: 121.80, text: "Bawat pangarap na ating pinag-usapan" },
    { time: 128.80, text: "Pupunta na lang ba ito sa wala?" },
    { time: 133.80, text: "Hayaan mong ituwid ang pagkakamali" },
    { time: 140.10, text: "Sa mga oras na 'to, alam kong ikaw ay lito" },
    { time: 146.40, text: "Lumalamig ang gabi" },
    { time: 152.90, text: "Hindi na tulad ng dati" },
    { time: 161.40, text: "May pag-asa pa ba kung susuko ka na?" },
    { time: 168.40, text: "Larawan mo ba'y lulukutin ko na?" },
    { time: 174.40, text: "Sa hirap at ginhawa, tayo ay nagsama" },
    { time: 181.10, text: "Damdamin mo tila'y napagod na" },
    { time: 187.70, text: "Ikaw at ako ay alaala na lang" },
    { time: 193.20, text: "Kung susuko ka na" },
    { time: 242.70, text: "May pag-asa pa ba kung susuko ka na?" },
    { time: 249.70, text: "Larawan mo ba'y lulukutin ko na?" },
    { time: 255.70, text: "Sa hirap at ginhawa, tayo ay nagsama" },
    { time: 262.40, text: "Damdamin mo tila'y napagod na" },
    { time: 269.10, text: "Ikaw at ako ay alaala na lang" },
    { time: 274.60, text: "Kung susuko ka na..." }
]
  },
    {
        id: 3,
