...
let songs = [
    ...
    lyrics: [
  { time: 14.0,  text: "Comparisons are easily done" },
  { time: 20.0,  text: "Once you've had a taste of perfection" },
  { time: 26.0,  text: "Like an apple hanging from a tree" },
  { time: 32.0,  text: "I picked the ripest one" },
  { time: 35.5,  text: "I still got the seed" },
  { time: 39.0,  text: "You said move on, where do I go?" },
  { time: 42.5,  text: "I guess second best is all I will know" },
  { time: 46.5,  text: "'Cause when I'm with him, I am thinking of you" },
  { time: 51.0,  text: "Thinking of you" },
  { time: 54.0,  text: "What you would do if you were the one" },
  { time: 57.5,  text: "Who was spending the night" },
  { time: 61.0,  text: "Oh, I wish that I" },
  { time: 63.5,  text: "Was looking into your eyes" },
  { time: 80.0,  text: "You're like an Indian summer" },
  { time: 84.0,  text: "In the middle of winter" },
  { time: 87.0,  text: "Like a hard candy" },
  { time: 90.0,  text: "With a surprise center" },
  { time: 93.5,  text: "How do I get better" },
  { time: 96.5,  text: "Once I've had the best" },
  { time: 99.5,  text: "You said there's tons of fish in the water" },
  { time: 103.0, text: "So the waters I will test" },
  { time: 108.0, text: "He kissed my lips, I taste your mouth" },
  { time: 114.0, text: "He pulled me in" },
  { time: 116.0, text: "I was disgusted with myself" },
  { time: 120.0, text: "'Cause when I'm with him, I am thinking of you" },
  { time: 124.0, text: "Thinking of you" },
  { time: 127.0, text: "What you would do if you were the one" },
  { time: 131.0, text: "Who was spending the night" },
  { time: 134.5, text: "Oh, I wish that I" },
  { time: 137.0, text: "Was looking into your eyes" },
  { time: 158.5, text: "You're the best" },
  { time: 161.0, text: "And yes, I do regret" },
  { time: 163.5, text: "How I could let myself" },
  { time: 166.0, text: "Let you go" },
  { time: 168.5, text: "Now the lesson's learned" },
  { time: 172.0, text: "I touched it, I was burned" },
  { time: 175.0, text: "Oh, I think you should know" },
  { time: 179.5, text: "'Cause when I'm with him, I am thinking of you" },
  { time: 184.0, text: "Thinking of you" },
  { time: 187.0, text: "What you would do if you were the one" },
  { time: 190.5, text: "Who was spending the night" },
  { time: 194.0, text: "Oh, I wish that I" },
  { time: 196.5, text: "Was looking into your eyes" },
  { time: 201.0, text: "Looking into your eyes" },
  { time: 208.0, text: "Oh, won't you walk through" },
  { time: 210.5, text: "And bust in the door" },
  { time: 213.0, text: "And take me away" },
  { time: 215.5, text: "Oh, no more mistakes" },
  { time: 218.5, text: "'Cause in your eyes I'd like to stay" }
]
  },
    ];
