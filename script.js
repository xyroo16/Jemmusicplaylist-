...
let songs = [
    ...
    },    
    {
        ...
        // Lyrics with timestamp in seconds
        lyrics: [
    { time: 3,   text: "Last night, all I think about is you" },
    ...
    { time: 30,  text: "Road shimmer wigglin' the vision" },
    { time: 32,  text: "Heat, heat waves, I'm swimmin' in a mirror" },
    { time: 36,  text: "Road shimmer wigglin' the vision" },
    { time: 38,  text: "Heat, heat waves, I'm swimmin' in a—" },
    { time: 42,  text: "Sometimes, all I think about is you" },
    { time: 45,  text: "Late nights in the middle of June" },
    { time: 47,  text: "Heat waves been fakin' me out" },
    { time: 51,  text: "Can't make you happier now" },
    { time: 54,  text: "Sometimes, all I think about is you" },
    { time: 57,  text: "Late nights in the middle of June" },
    { time: 60,  text: "Heat waves been fakin' me out" },
    { time: 63,  text: "Can't make you happier now" },
    { time: 66,  text: "Usually I put somethin' on TV" },
    { time: 69,  text: "So we never think about you and me" },
    { time: 72,  text: "But today I see our reflections clearly" },
    { time: 75,  text: "In Hollywood, layin' on the screen" },
    { time: 78,  text: "You just need a better life than this" },
    { time: 81,  text: "You need somethin' I can never give" },
    { time: 84,  text: "Fake water all across the road" },
    { time: 87,  text: "It's gone now, the night has come, but" },
    { time: 91,  text: "Sometimes, all I think about is you" },
    { time: 94,  text: "Late nights in the middle of June" },
    { time: 97,  text: "Heat waves been fakin' me out" },
    { time: 100, text: "Can't make you happier now" },
    { time: 103, text: "You can't fight it, you can't breathe" },
    { time: 106, text: "You say somethin' so lovin', but" },
    { time: 109, text: "Now I gotta let you go" },
    { time: 112, text: "You'll be better off with someone new" },
    { time: 115, text: "I don't wanna be alone" },
    { time: 118, text: "You know it hurts me too" },
    { time: 121, text: "You look so broken when you cry" },
    { time: 124, text: "One more and then I say goodbye" },
    { time: 127, text: "Sometimes, all I think about is you" },
    { time: 130, text: "Late nights in the middle of June" },
    { time: 133, text: "Heat waves been fakin' me out" },
    { time: 136, text: "Can't make you happier now" },
    { time: 140, text: "I just wonder what you're dreamin' of" },
    { time: 143, text: "When you sleep and smile so comfortable" },
    { time: 146, text: "I just wish that I could give you that" },
    { time: 149, text: "That look that's perfectly un-sad" },
    ...
    { time: 162, text: "Heat waves been fakin' me out" },
    { time: 166, text: "Sometimes, all I think about is you" },
    { time: 169, text: "Late nights in the middle of June" },
    { time: 172, text: "Heat waves been fakin' me out" },
    { time: 175, text: "Can't make you happier now" },
]
    },
    {
        id: 4,
