...
let songs = [
    ...
    { time: 13.61, text: "Sa dami-rami na ng ating pinagdaanan" },
    { time: 20.38, text: "Ngayon mo pa ba maiisipang isuko" },
    { time: 26.42, text: "Ang lahat ng ating pinagsamahan" },
    { time: 32.79, text: "Masikip sa damdamin, hinigop ng hangin" },
    { time: 39.31, text: "Ang lakas, pinanghihinaan nang wagas" },
    { time: 45.71, text: "Pwede bang pag-isipan, huwag ka munang lumiban" },
    { time: 52.40, text: "Baka sakali na ito ay maisalba pa" },
    { time: 58.70, text: "Lumalamig ang gabi" },
    { time: 65.30, text: "Hindi na tulad ng dati" },
    { time: 73.80, text: "May pag-asa pa ba kung susuko ka na?" },
    { time: 80.80, text: "Larawan mo ba'y lulukutin ko na?" },
    { time: 86.80, text: "Sa hirap at ginhawa, tayo ay nagsama" },
    { time: 93.50, text: "Damdamin mo tila'y napagod na" },
    { time: 100.10, text: "Ikaw at ako ay alaala na lang" },
    { time: 105.60, text: "Kung susuko ka na" },
    { time: 113.87, text: "Bawat pangarap na ating pinag-usapan" },
    { time: 120.87, text: "Pupunta na lang ba ito sa wala?" },
    { time: 125.89, text: "Hayaan mong ituwid ang pagkakamali" },
    { time: 132.20, text: "Sa mga oras na 'to, alam kong ikaw ay lito" },
    { time: 138.50, text: "Lumalamig ang gabi" },
    { time: 145.00, text: "Hindi na tulad ng dati" },
    { time: 153.50, text: "May pag-asa pa ba kung susuko ka na?" },
    { time: 160.50, text: "Larawan mo ba'y lulukutin ko na?" },
    { time: 166.50, text: "Sa hirap at ginhawa, tayo ay nagsama" },
    { time: 173.20, text: "Damdamin mo tila'y napagod na" },
    { time: 179.90, text: "Ikaw at ako ay alaala na lang" },
    { time: 185.40, text: "Kung susuko ka na" },
    { time: 234.85, text: "May pag-asa pa ba kung susuko ka na?" },
    { time: 241.82, text: "Larawan mo ba'y lulukutin ko na?" },
    { time: 247.84, text: "Sa hirap at ginhawa, tayo ay nagsama" },
    { time: 254.58, text: "Damdamin mo tila'y napagod na" },
    { time: 261.33, text: "Ikaw at ako ay alaala na lang" },
    { time: 266.84, text: "Kung susuko ka na..." }
]
  },
    {
        id: 3,
