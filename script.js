...
let songs = [
    ...
    lyrics: [
  { time: 13.60, text: "Comparisons are easily done" },
  { time: 20.10, text: "Once you've had a taste of perfection" },
  ...
  { time: 39.50, text: "You said move on, where do I go?" },
  { time: 43.00, text: "I guess second best is all I will know" },
  { time: 47.20, text: "'Cause when I'm with him, I am thinking of you" },
  { time: 48.60, text: "Thinking of you" },
  { time: 51.70, text: "What you would do if you were the one" },
  { time: 54.60, text: "Who was spending the night" },
  { time: 59.30, text: "Oh, I wish that I" },
  { time: 61.30, text: "Was looking into your eyes" },
