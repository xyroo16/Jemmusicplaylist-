...
let songs = [
    ...
    { time: 20.1, text: "Once you've had a taste of perfection" },
    { time: 26.2, text: "Like an apple hanging from a tree" },
    { time: 32.7, text: "I picked the ripest one" },
    { time: 36.3, text: "I still got the seed" },
    { time: 39.5, text: "You said move on, where do I go?" },
    { time: 43.0, text: "I guess second best is all I will know" },
    { time: 47.2, text: "'Cause when I'm with him, I am thinking of you" },
    { time: 51.8, text: "Thinking of you" },
    { time: 54.8, text: "What you would do if you were the one" },
    { time: 58.5, text: "Who was spending the night" },
    { time: 62.3, text: "Oh, I wish that I" },
    { time: 64.8, text: "Was looking into your eyes" },
    { time: 81.3, text: "You're like an Indian summer" },
    { time: 85.5, text: "In the middle of winter" },
    { time: 88.8, text: "Like a hard candy" },
    { time: 92.0, text: "With a surprise center" },
    { time: 95.4, text: "How do I get better" },
    { time: 98.7, text: "Once I've had the best" },
    { time: 101.5, text: "You said there's tons of fish in the water" },
    { time: 105.2, text: "So the waters I will test" },
    { time: 109.8, text: "He kissed my lips, I taste your mouth" },
    { time: 115.8, text: "He pulled me in" },
    { time: 117.5, text: "I was disgusted with myself" },
    { time: 121.2, text: "'Cause when I'm with him, I am thinking of you" },
    { time: 125.8, text: "Thinking of you" },
    { time: 128.8, text: "What you would do if you were the one" },
    { time: 132.5, text: "Who was spending the night" },
    { time: 136.3, text: "Oh, I wish that I" },
    { time: 138.8, text: "Was looking into your eyes" },
    { time: 160.0, text: "You're the best" },
    { time: 162.5, text: "And yes, I do regret" },
    { time: 165.0, text: "How I could let myself" },
    { time: 167.5, text: "Let you go" },
    { time: 170.0, text: "Now the lesson's learned" },
    { time: 173.5, text: "I touched it, I was burned" },
    { time: 176.5, text: "Oh, I think you should know" },
    { time: 181.2, text: "'Cause when I'm with him, I am thinking of you" },
    { time: 185.8, text: "Thinking of you" },
    { time: 188.8, text: "What you would do if you were the one" },
    { time: 192.5, text: "Who was spending the night" },
    { time: 196.3, text: "Oh, I wish that I" },
    { time: 198.8, text: "Was looking into your eyes" },
    { time: 203.0, text: "Looking into your eyes" },
    { time: 210.0, text: "Oh, won't you walk through" },
    { time: 212.5, text: "And bust in the door" },
    { time: 215.0, text: "And take me away" },
    { time: 217.5, text: "Oh, no more mistakes" },
    { time: 220.5, text: "'Cause in your eyes I'd like to stay" }
]
  },
 ];
