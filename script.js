...
let songs = [
    ...
    { time: 14, text: "Para mabuhay habang-buhay sa puso't isipan Mo" },
    { time: 28, text: "Sino ba ako para mapansin Mo?" },
    { time: 34, text: "Mga dalangin ko sa 'Yo, sana'y pakinggan Mo" },
    { time: 52, text: "[Verse 2]" },
    { time: 54, text: "Pa'no ba ako magiging 'sang santo" },
    { time: 66, text: "Para makasama Kita diyan sa tabi ng trono Mo?" },
    { time: 78, text: "Ilan pang pagsubok ang daraanan ko" },
    { time: 90, text: "Bago ako makaranas ng mga milagro Mo?" },
    { time: 116, text: "[Bridge]" },
    { time: 118, text: "Oh, ang langit ay nandito lamang pala sa lupa" },
    { time: 127, text: "At ang impiyerno ay nasa isipan ko, at pinalimot ng 'Yong ganda" },
    { time: 137, text: "Umaawit ang mga anghel, umaawit ang mga anghel" },
    { time: 146, text: "Nagdiriwang sila nang makasama Kita, huwag Ka sanang mawawala" },
    { time: 155, text: "Ooh..." },
    { time: 162, text: "Ooh, ooh, ooh, ooh" },
    { time: 170, text: "Ooh..." },
    { time: 178, text: "[Chorus]" },
    { time: 180, text: "Mamamatay akong nakangiti" },
    { time: 185, text: "Kapag Ikaw ang nasa aking tabi" },
    { time: 190, text: "Mabubuhay akong nagsisisi" },
    { time: 194, text: "Kapag isang araw hindi Kita mapapangiti" },
    { time: 199, text: "Kalapastangan ang 'di Ka ibigin" },
    { time: 204, text: "Kalokohan ang 'di Ka isipin" },
    { time: 209, text: "Kung ang mundo ay biglang gugunawin" },
    { time: 213, text: "Ikaw ang una kong hahanapin" },
    { time: 225, text: "[Outro]" }
]
},
 ];
